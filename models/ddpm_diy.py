...
class ResBlock(nn.Module):
    def __init__(self, in_ch: int, out_ch: int, time_emb_dim: int, dropout: float = 0.0):
        ...
        self.time_proj = LinearDense(time_emb_dim, out_ch)
...
class UNetDDPMDIY(nn.Module):
    def __init__(
        ...
        self.time_embed = nn.Sequential(
            ...
            LinearDense(time_emb_dim, time_emb_dim * 4),
            nn.SiLU(),
            LinearDense(time_emb_dim * 4, time_emb_dim),
        )
