...
from models.ddpm2 import UNetDDPM
...
def train(
    num_epochs: int = 50,
    out_dir: str = "./data/gen/ddpm_outputs",
    T: int = 400,
):
    ...
    history.plot_history("epochs", "./data/plots/ddpm_history.png")
